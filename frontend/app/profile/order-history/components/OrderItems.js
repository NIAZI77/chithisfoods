import { ShoppingBag, Flame, Star, DollarSign, Sigma, Truck } from "lucide-react";
            ...
            <div className="w-16 md:w-20 relative rounded overflow-hidden flex-shrink-0 aspect-video">
              ...
              />
                  ...
                  <div className="text-right flex-shrink-0">
                       ...
                       ${(parseFloat(dish.total) || parseFloat(dish.basePrice) * (dish.quantity || 1) || 0).toFixed(2)}
                     </div>
                    <div className="text-xs text-gray-500 mt-0.5">
        ...
        <div className="flex justify-between items-center">
          <span className="text-xs font-medium text-gray-700 flex items-center gap-1">
            ...
            Total Items:
             ...
             {Array.isArray(order.dishes) ? order.dishes.reduce((sum, dish) => sum + (parseInt(dish.quantity) || 1), 0) : 0}
           </span>
        </div>
                 <div className="flex justify-between items-center">
           <span className="text-xs font-medium text-gray-700 flex items-center gap-1">
