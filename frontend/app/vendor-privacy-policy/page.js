      ...
      <div className="space-y-6">
        <section>
          <p className="text-gray-700 mb-4">
            At Chithi&apos;s Foods, we value the privacy and trust of our
            vendors. This Vendor Privacy Policy (&quot;Policy&quot;) outlines
            how we collect, use, disclose, and protect the personal and business
            information of our vendors. By partnering with Chithi&apos;s Foods,
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4">
            We may collect the following types of information from our vendors:
          </p>
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>
              <strong>Business Information:</strong> Business name, address, tax
              identification number, and other relevant business details.
            </li>
            <li>
              <strong>Contact Information:</strong> Names, phone numbers, email
              addresses, and other contact details of authorized
              representatives.
            </li>
            <li>
              <strong>Financial Information:</strong> Bank account details,
              payment history, and other financial information necessary for
              transactions.
            </li>
            <li>
              <strong>Operational Information:</strong> Product details,
              inventory levels, delivery schedules, and performance metrics.
            </li>
            <li>
              <strong>Technical Information:</strong> IP addresses, device
              information, and usage data when you access our vendor portal or
              platforms.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>
              To communicate with you about orders, deliveries, and other
              operational matters.
            </li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>
              ...
              providers who assist us in payment processing, delivery, and other
              business operations.
            </li>
            <li>
            ...
            <li>
              ...
              acquisition, or sale of assets, where vendor information may be
        ...
        <section>
          <p className="text-gray-700">
            Thank you for partnering with Chithi&apos;s Foods. We are committed
            to protecting your privacy and ensuring a transparent and secure
