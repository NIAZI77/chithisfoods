...
const REQUIRED_FIELDS = ["serviceArea"];
...
const Page = () => {
  ...
  const fetchVendorData = async (email) => {
    try {
      ...
      setFormData({
        ...
        serviceArea: Array.isArray(vendorData.serviceArea) ? vendorData.serviceArea : [],
        vendorDeliveryFee:
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-8 w-full pl-16">
      <h1 className="text-2xl md:text-3xl font-bold mb-8">Vendor Settings</h1>
