          ...
          {(savedAddresses || []).map((address) => (
            ...
            >
              <div className="flex items-start gap-3 sm:gap-4">
                <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 flex items-center justify-center mt-1 flex-shrink-0 ${
                  selectedAddressId === address.id 
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-black text-gray-900 mb-1 text-sm sm:text-base">{address.name}</div>
                  ...
                  <div className="flex items-start gap-2 text-xs sm:text-sm text-gray-800">
                    ...
                    <span className="leading-relaxed break-words">{address.address}</span>
                  </div>
                </div>
        ...
        <div className="text-center py-6 sm:py-8">
          <div className="inline-flex flex-col items-center gap-3 px-6 sm:px-8 py-4 sm:py-6 bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg sm:rounded-xl">
            ...
            <div className="text-center">
              <div className="font-semibold text-gray-600 mb-1 text-sm sm:text-base">No saved addresses</div>
