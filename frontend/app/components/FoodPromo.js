  ...
  return (
    <section className="bg-green-50 rounded-2xl p-8 grid md:grid-cols-2 lg:grid-cols-3 gap-8 w-[90%] mx-auto shadow-lg mt-10 items-center">
      ...
      <div className="order-2 md:order-1 text-center md:text-left lg:col-span-2 md:px-4">
        ...
        <button className="mt-6 py-2 px-6 bg-rose-600 text-white rounded-full shadow-rose-300 shadow-md hover:bg-rose-700 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed">
          Order Now
        </button>
      </div>
    </section>
