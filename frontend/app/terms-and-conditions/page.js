...
const TermsOfService = () => {
  return (
    <div className="md:w-[80%] w-[90%] mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        By placing an order through our Services, you agree to provide accurate
        and complete information. All orders are subject to availability and
        confirmation.
      </p>
      <h3 className="text-xl font-medium">Payments:</h3>
      <p className="mb-4">
        Payment is processed through secure third-party payment gateways. You
        agree to pay all charges incurred in connection with your order,
        including taxes and delivery fees.
      </p>
      <h3 className="text-xl font-medium">Cancellations:</h3>
      <p className="mb-4">
        Orders may be canceled or modified only within a specified time frame.
      ...
      <p className="mb-4">
        Refunds may be issued for canceled orders or in cases of incorrect or
        unsatisfactory orders. Refund eligibility is determined on a
        case-by-case basis.
      </p>
