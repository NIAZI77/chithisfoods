      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="space-y-2 text-gray-700">
            <p>
              ...
              <strong>accurate and complete information</strong>. All orders are
              subject to availability and confirmation.
            </p>
            <p>
              <strong>Payments:</strong> Payment is processed through{" "}
              <strong>secure third-party payment gateways</strong>. You agree to
              pay all charges incurred in connection with your order, including
              taxes and delivery fees.
            </p>
            <p>
              <strong>Cancellations:</strong> Orders may be canceled or modified
              only within a <strong>specified time frame</strong>. Once an order
              is processed, cancellations may not be possible.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            delays caused by third-party delivery services or unforeseen
            circumstances.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-2 text-gray-700">
            <p>
              ...
              eligibility is determined on a <strong>case-by-case basis</strong>
              .
            </p>
            <p>
              <strong>Returns:</strong> If you receive a damaged or incorrect
              product, please contact us within <strong>24 hours</strong> of
              delivery to arrange a return or replacement.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <li>
              <strong>Harass, abuse, or harm</strong> others.
            </li>
            <li>
              <strong>Impersonate</strong> any person or entity.
            </li>
            <li>
              <strong>Interfere</strong> with the operation of our Services.
            </li>
            <li>
              Upload or transmit <strong>viruses or malicious code</strong>.
            </li>
          </ul>
        </section>
